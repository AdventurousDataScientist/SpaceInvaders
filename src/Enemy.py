...
class Enemy(object):
    ...
    def shoot(self,fire):
        ...
        bullet_sound = mixer.Sound('src/Entities/Player/sounds/laser.wav')
        if fire == True:
            default_position = '6'
            if self.type == 'Boss':
                damage = 10
            ...
            if self.num_bullets == 1:
                if self.type == 'Boss':
                    image = 'src/Entities/Enemy/Boss/boss_6_position.png'
                else:
                    image = 'src/Entities/Enemy/enemy_6_position.png'
